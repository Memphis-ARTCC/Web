...
namespace Memphis.Shared.Migrations
{
    ...
    [Migration("20240615144943_Positions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Memphis.Shared.Models.Hours", b =>
                {
                    ...
                    b.Property<double>("ApproachHours")
            ...
            modelBuilder.Entity("Memphis.Shared.Models.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Memphis.Shared.Models.Settings", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            LastUpdated = new DateTimeOffset(new DateTime(2024, 6, 15, 14, 49, 42, 277, DateTimeKind.Unspecified).AddTicks(4205), new TimeSpan(0, 0, 0, 0, 0)),
                            RequiredHours = 3,
                            VisitingOpen = true
                        });
                });
